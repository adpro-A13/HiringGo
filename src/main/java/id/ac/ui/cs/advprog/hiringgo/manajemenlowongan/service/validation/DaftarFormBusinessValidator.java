...
@Component
public class DaftarFormBusinessValidator {

    private static final double MIN_IPK = 2.5;
    private static final int MIN_SKS = 12;
    private static final int MAX_SKS = 24;

    public void validateBusinessRules(DaftarForm daftarForm) {
        validateIpk(daftarForm.getIpk());
        validateSks(daftarForm.getSks());
    }
